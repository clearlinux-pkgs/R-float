...
Version  : 0.3.0
Release  : 8
URL      : https://cran.r-project.org/src/contrib/float_0.3-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/float_0.3-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659758564
