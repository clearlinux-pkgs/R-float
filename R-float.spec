...
Version  : 0.3.3
Release  : 20
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/float_0.3-3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/float_0.3-3.tar.gz
...
%package dev
Summary: dev components for the R-float package.
Group: Development
Requires: R-float-lib = %{version}-%{release}
Provides: R-float-devel = %{version}-%{release}
Requires: R-float = %{version}-%{release}

%description dev
dev components for the R-float package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742473233
